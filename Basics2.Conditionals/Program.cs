...
namespace Jarai.CSharp.Basics.Conditionals
{
    internal class Program
    {
        private static void Main()
        {
            ...
            AusgabeMitIf(eingabe);

            AusgabeMitSwitch(eingabe);

            AusgabeMitArray(eingabe);

            Console.ReadLine();
        }

        private static void AusgabeMitArray(string eingabe)
        {
        ...
        private static void AusgabeMitSwitch(string eingabe)
        {
            switch (eingabe)
            {
                case "1":
        ...
        private static void AusgabeMitIf(string eingabe)
        {
            if (eingabe == "1")
            {
                Console.WriteLine("Sehr gut");
